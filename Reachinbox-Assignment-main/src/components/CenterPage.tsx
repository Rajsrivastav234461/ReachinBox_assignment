  ...
  return (
    <div className="overflow-y-scroll no-scrollbar  h-full">
      <div className="border-b-2 dark:border-[#33383F] border-[#E0E0E0] w-full flex justify-between px-8 py-4">
        <div>
          <div className="dark:text-white text-black text-lg">Nitesh</div>
          <div className="dark:text-[#FFFFFF66] text-[#343A40B2] text-sm">srivastavnitesh513@gmail.com</div>
        </div>
    ...
    <div className="dark:bg-[#141517] bg-white border dark:border-[#343A40] mx-8 rounded-md my-3">
      <div className="p-4">
        <div className="flex justify-between py-4">
          ...
          <div className="text-sm dark:text-[#7F7F7F] text-[#637381]">28 aug 2024 : 22.06</div>
        </div>
        <div
