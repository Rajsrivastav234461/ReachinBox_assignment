    ...
    <div className="border-l-2 bg-white dark:bg-black dark:border-[#33383F] border-[#E0E0E0] h-full overflow-y-scroll no-scrollbar px-2">
      ...
      <div className="px-6 my-10 space-y-6 dark:text-white text-[#637381]">
        <div className="flex justify-between text-sm">
          ...
          <div className="dark:text-[#B9B9B9]">Nitesh</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Contact No</div>
          <div className="dark:text-[#B9B9B9]">+91-9026316527</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Email ID</div>
          <div className="dark:text-[#B9B9B9]">srivastavnitesh513@gmail.com</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Linkedin</div>
          <div className="dark:text-[#B9B9B9]">linkedin.com/nitesh-srivastava-15a059221/</div>
        </div>
        <div className="flex justify-between text-sm">
        ...
        <div className="px-2">
          <div className="flex my-4 items-center">
            ...
            <div className="ml-10 space-y-2 text-black dark:text-white">
              ...
              <div className="text-[#B9B9B9] text-sm flex items-center ">
                {" "}
                <IoIosSend className="mr-2" /> Sent 3rd, Aug
              </div>
            </div>
          </div>
          ...
          <div className="flex my-4 items-center">
            ...
            <div className="ml-10 space-y-2 text-black dark:text-white">
              ...
              <div className="text-[#B9B9B9] text-sm flex items-center ">
                {" "}
                <IoMailOpen className="mr-2 text-yellow-500" /> Open 28th, Aug
              </div>
            </div>
          </div>
